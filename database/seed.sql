...
-- 2. Users (Hashed password for 'admin123', 'reception123', 'doctor123' using bcrypt salt 10)
...
('doc-iyer', 'u-driyer', 'Dr. Vikram Iyer', 'Consultant Cardiologist', 'dept-cardio', '302', '3', 'AVAILABLE', 20.0)
ON CONFLICT (id) DO NOTHING;
...
-- 5. Appointments & Initial Queue Entries (Token format: ORTH-101, ORTH-102...)
...
-- 6. Queue Entries (A101 - A105 under Orthopedics)
...
-- 7. Digital Intake Form for A103 (Aarav Mehta - MRI Review)
